...
const Notification = () => {
  return (
    <div className="flex flexbetween items-center bg-slate-300 text-slate-950 mb-6">
      ...
      <div className="my-1 mx-6 text-center ">
        <p className="text-secondary capitalize font-semibold  rounded-xl mt-1 p-1">
           <span className="uppercase font-extrabold text-red-600">black friday offer!</span> use
          code <span className="font-extrabold text-red-600 uppercase text-xl text-pulse">"20% off"</span> at
