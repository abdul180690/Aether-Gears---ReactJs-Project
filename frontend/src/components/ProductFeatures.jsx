...
const ProductFeatures = () => {
  return (
    <div className='bg-primary rounded-xl mt-8 ring-1 ring-slate-900/10'>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 rounded-xl'>
            <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
                ...
                <div>
                    ...
                    <p>
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odit, minus accusamus expedita quo non aliquid?
                    </p>
                </div>
            </div>
            <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
