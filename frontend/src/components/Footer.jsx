        ...
        <div className="flex flex-col max-w-sm gap-y-5">
          <div className="bold-28">
            <div className="flex items-center">
              <img src={logo} alt="Aether Gears Logo" className="w-7 h-7 me-3" />
              <span className="text-white">Aether Gears</span>
            </div>
          </div>
          <p className="text-white content-stretch text-justify line-clamp-6">
          ...
          <div className="flex items-center gap-3 bg-white  justify-center rounded-2xl">
            <img src={cards} alt="Payment Cards" width={144} className="" />
            <img src={netbanking} alt="Net Banking" width={60} className="" />
            <img src={cod} alt="Cash on Delivery" width={24} className="" />
          </div>
        </div>
