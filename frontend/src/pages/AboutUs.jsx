...
const AboutUs = () => {
  ...
  return (
    <>
      ...
      <section className="w-fit">
        <div className=" relative h-[450px] flex items-center justify-center  overflow-hidden">
          ...
          <div className="relative text-center text-slate-800 ">
            <Title title1={"About "} title2={"Us"} titleStyles={"scroll-section"}  />
            <h1 className="md:text-lg lg:text-xl/10 mx-4 md:mx-20 lg:mx-60 mt-5 scroll-section">
      ...
      {/* Section: Our Mission */}
      <section className="max-padd-container py-16 px-6 lg:px-10">
        <div className="">
          <Title title1={"Our "} title2={"Mission"} title1Styles={"text-center scroll-section"} />
          <p className="mx-10 mb-3 text-center text-secondary text-xl/10 scroll-section">
      ...
      <section className="max-padd-container text-center py-10">
        <div className="max-padd-container">
          <Title
            title1={"Why Choose "}
            title2={"Aether Gears"}
            title1Styles={"text-center mb-10 scroll-section"}
          />
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-6 lg:px-10">
            <div className="bg-amber-300 p-6 rounded-xl shadow-lg text-center scroll-section">
              <div className="flexCenter mb-5">
                <MdWorkspacePremium className="text-secondary me-5 bg-white p-1 rounded-full text-4xl" />
            ...
            <div className="bg-amber-300 p-6 rounded-xl shadow-lg text-center scroll-section">
              <div className="flexCenter mb-5">
                <PiCurrencyInrBold className="text-secondary me-5 bg-white p-1 rounded-full text-4xl" />
                <h4 className="text-xl font-bold text-gray-800">
                  Affordable Prices
                </h4>
              </div>
            ...
            <div className="bg-amber-300 p-6 rounded-xl shadow-lg text-center scroll-section">
              <div className="flexCenter mb-5">
                <MdOutlineSupportAgent className="text-secondary me-5 bg-white p-1 rounded-full text-4xl" />
                <h4 className="text-xl font-bold text-gray-800">
                  Excellent Support
                </h4>
              </div>
      ...
      <section className="py-10 px-6 lg:px-10">
        <div className="">
          <Title title1={"THE TEAM "} title2={"BEHIND"} title1Styles={"scroll-section text-center"} />
          <h1 className="mb-3 text-center h3 scroll-section">Our Team Experts</h1>
          <p className="mx-10 mb-3 text-center text-secondary text-xl/10 scroll-section">
          ...
          <div className="flex flex-wrap gap-20 justify-center items-center mt-20">
            {[{ name: "Richard", role: "Creative Head", img: creative_lead }, 
              ...
              <div
                key={idx}
                className="flex relative mx-5 pb-18 bg-white rounded-2xl justify-center items-center w-full sm:w-5/12 md:w-4/12 lg:w-3/12 h-5/6 shadow-xl scroll-section group"
              >
                ...
                <div className="flex-col absolute inset-0 bg-red-900 bg-opacity-10 justify-center items-center text-center text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl">
                  <div className="lg:mt-40 xs:mt-48 inline-block bg-orange-500 rounded-xl px-6 py-1">
                    <h1 className="text-2xl font-semibold">{member.name}</h1>
                    <h2 className="mt-1 text-xl text-nowrap ">{member.role}</h2>
