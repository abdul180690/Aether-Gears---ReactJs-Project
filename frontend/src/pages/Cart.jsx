...
const Cart = () => {
  ...
  // Update cartData and quantities when cartItems or products change
  useEffect(() => {
  ...
  const firstProduct = cartData[0]
    ? products.find((product) => product._id === cartData[0]._id)
    : null;
  ...
  return (
    <>
        ...
        <div className="max-padd-container">
          ...
          {getCartCount() === 0 ? (
            ...
            >
              ...
              <p className="text-gray-500 mt-2 text-xl text-center">
            ...
            <>
              ...
              >
                ...
                <h5 className="relative -bottom-3 pl-3 text-gray-500">
                  ({getCartCount()} Items)
                </h5>
              </motion.div>
              <div className="flex flex-wrap lg:flex-nowrap gap-8 mt-5">
                        ...
                        <div className="flex items-center  gap-x-5 overflow-hidden">
                          ...
                          <div className="flex flex-col w-full">
                            ...
                            <div className="flexBetween">
                              ...
                              <h4 className="h4">
                                {currency}{" "}
                                {(quantities[key] * productData.price).toFixed(
                                  2
                                )}
                              </h4>
                            </div>
                ...
                >
                  ...
                  <div>
                    ...
                    {getCartAmount() < 1000 ? (
                      <div className="mb-5">
                        <h3 className="text-gray-900 text-sm mb-1.5">
                        ...
                        <div className="w-full h-2 bg-gray-200 rounded-full">
                          <div
                            ...
                            style={{
                              width: `${Math.min(
                                (getCartAmount() / 1000) * 100,
                                100
                              )}%`, // Calculate percentage based on cartAmount
                            }}
                          ></div>
                        </div>
                        <p className="text-sm text-gray-900 mt-1.5">
                          <span className="bold-15">
                            {" "}
                            {currency}
                            {1000 - getCartAmount()}{" "}
                          </span>{" "}
                      ...
                      <div className="mb-4 flexCenter">
                        ...
                        <h3 className=" bold-18 text-green-600">
                    ...
                    <div className="flex justify-between items-center">
                      <h1>
                        Subtotal <span>({getCartCount()} Items)</span>
                      </h1>
                      <h3 className="bold-24">
                        <span className="text-base">{currency}</span> {getCartAmount()}/-
                      </h3>
                    </div>
                    <button
                    ...
                    >
                      Proceed to Checkout{" "}
                      <MdShoppingCartCheckout className="ml-3 " />
                    </button>
                  </div>
                </motion.div>
              </div>
      ...
      {/* Modal Confirmation Popup for remove item in the cart*/}
      {showModal && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-70 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadowed lg:w-2/4 xs:w-3/4 ">
