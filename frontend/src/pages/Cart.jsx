...
//                                                     </button>
//                                                 </div>
//                                                 <h4 className='h4'>{currency} {( quantities[key] * productData.price)}</h4>
//                                             </div>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                         <CartTotal />
//                         <button onClick={() => navigate('/place-order')} className='btn-secondary mt-2'>Proceed to Checkout</button>
//                     </div>
//                 </div>
//             </div>
//         </div>
