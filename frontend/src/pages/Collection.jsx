...
//         <div className={`p-4 pt-18 ${open ? "w-82" : "w-20"} duration-300 relative`}>
//           <FaArrowCircleLeft onClick={() => setOpen(!open)} className={`bg-white text-dark-purple text-3xl rounded-full absolute -right-3 top-9 border border-dark-purple cursor-pointer ${!open && "rotate-180"}`} />
//           <Search className={`${!open && "hidden"} duration-300`}/>
    ...
    <>
      <div className="mt-16 p-5 bg-primary max-padd-container !px-0">
        <div className="flex flex-col sm:flex-row gap-8">
          ...
          <div
            className={`p-4 pt-18 relative ${open ? 'w-3/12 duration-500' : 'w-24 duration-500'}`}
          >
            <FaArrowRight
              onClick={() => setOpen(!open)}
              className={`p-2 bg-white text-dark-purple text-5xl rounded-full absolute -right-3 top-9 border border-dark-purple cursor-pointer ${
                open ? 'rotate-180 duration-500 mt-7 ml-5' : 'duration-500'
              }`}
            />
            {open && (
              <>
                <Search />
                <div className="px-5 py-3 mt-4 bg-white rounded-xl">
                  <h5 className="h5 mb-4">Categories</h5>
                  <div className="flex flex-col gap-2 text-sm font-light">
                    {[
                      'Headphones',
